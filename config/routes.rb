Rails.application.routes.draw do
  ...
  # End points that do not require authorization.
  root 'application#index'
  get 'no_auth'=> 'application#no_auth', as: :no_auth

  # basic_controller.rb; Main controller that loads the JS.
  get ':project_name(/:component_name(/:model_name(/:record_name)))', to:'basic#index'
