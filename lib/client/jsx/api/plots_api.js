...
export const plotIndexUrl = (queryParams) => {
  let path = Routes.plots_path(APP_CONFIG.project_name);
...
export const fetchPlots = ()=>{
  ...
  let route = Routes.plots_fetch_path(APP_CONFIG.project_name);
...
export const createPlot = (plot)=>{
  ...
  let route = Routes.plots_create_path(APP_CONFIG.project_name);
...
export const destroyPlot = (plot)=>{
  ...
  let route = Routes.plots_destroy_path(APP_CONFIG.project_name, plot.id);
...
export const updatePlot = (plot)=>{
  ...
  let route = Routes.plots_update_path(APP_CONFIG.project_name, plot.id);
